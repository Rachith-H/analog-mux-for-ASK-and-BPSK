...
S {}
E {}
N -4350 -2630 -4350 -2560 {lab=#net1}
...
N -4350 -2750 -4350 -2740 {lab=GND}
N -4630 -2740 -4350 -2740 {lab=GND}
N -4630 -2740 -4630 -2650 {lab=GND}
...
N -4320 -2520 -4290 -2520 {lab=out}
N -4290 -2520 -4290 -2510 {lab=out}
N -4410 -2520 -4380 -2520 {lab=#net3}
N -4410 -2520 -4410 -2510 {lab=#net3 Carrier signal}
N -4630 -2500 -4350 -2500 {lab=GND}
N -4350 -2520 -4350 -2500 {lab=GND}
...
C {vsource.sym} -4580 -2440 0 0 {name=V3 value="SIN(5 5 600 0 0 180)" savecurrent=false}
...
.control
run
plot v(net1)+10 v(net2)+22 v(net3)+34 v(net4)+46 v(out)

.endc
"}
C {nmos4.sym} -4350 -2770 1 0 {name=M1 model=nmos w=5u l=0.18u del=0 m=1}
C {nmos4.sym} -4350 -2540 1 0 {name=M2 model=nmos w=5u l=0.18u del=0 m=1}
